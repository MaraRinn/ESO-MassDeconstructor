  ...
  local options = {
    ...
    },
    {
      ...
      controls = {
        ...
        {
          type = "checkbox",
          name = "Allow mass deconstruction",
          tooltip = 'Allow Mass Deconstructor to deconstruct clothing items',
          default = true,
          getFunc = function() return set.Clothing.AllowDeconstruction end,
          setFunc = function(allowDecon) set.Clothing.AllowDeconstruction = allowDecon end,
        },
      },
    },
    {
      ...
      controls = {
        ...
        },
        {
          type = "checkbox",
          name = "Allow mass deconstruction",
          tooltip = 'Allow Mass Deconstructor to deconstruct blacksmithing items',
          default = true,
          getFunc = function() return set.Blacksmithing.AllowDeconstruction end,
          setFunc = function(allowDecon) set.Blacksmithing.AllowDeconstruction = allowDecon end,
        },
      },
    },
    {
      ...
      controls = {
        ...
        },
        {
          type = "checkbox",
          name = "Allow mass deconstruction",
          tooltip = 'Allow Mass Deconstructor to deconstruct woodworking items',
          default = true,
          getFunc = function() return set.Woodworking.AllowDeconstruction end,
          setFunc = function(allowDecon) set.Woodworking.AllowDeconstruction = allowDecon end,
        },
      },
    },
    {
      ...
      controls = {
        ...
        },
        {
          ...
          tooltip = 'Allow Mass Deconstructor to deconstruct clothing items',
          default = true,
          getFunc = function() return set.Enchanting.AllowDeconstruction end,
          setFunc = function(allowDecon) set.Enchanting.AllowDeconstruction = allowDecon end,
        },
      },
    },
    {
      ...
      controls = {
        ...
        },
        {
          ...
          tooltip = 'Allow Mass Deconstructor to deconstruct clothing items',
          default = true,
          getFunc = function() return set.JewelryCrafting.AllowDeconstruction end,
          setFunc = function(allowDecon) set.JewelryCrafting.AllowDeconstruction = allowDecon end,
        },
      },
    },
